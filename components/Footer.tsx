        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-2.5">
              {/* Facebook */}
              <a href="#" className="w-8 h-8 rounded-full flex items-center justify-center glass-panel text-white/40 hover:text-[#E8B96A] transition-all duration-300 hover:shadow-[0_0_15px_rgba(232,185,106,0.3)] hover:scale-105">
